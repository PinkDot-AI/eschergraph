...
PDF_LABELED_DATA_ROOT_PATH = Path(
  join(PDF_TOKENS_TYPE_ROOT_PATH.parent.absolute(), "pdf-labeled-data")
)
TOKEN_TYPE_LABEL_PATH = Path(
  join(PDF_LABELED_DATA_ROOT_PATH, "labeled_data", "token_type")
)
