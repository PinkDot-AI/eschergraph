...
def search(vector_db: VectorDB, query: str, model: ModelProvider) -> str:
...
def _get_attributes(
  vector_db: VectorDB, query: str, model: ModelProvider
  ...
  if api_key:
    ...
    reranked_attributes = JinaReranker().rerank(
      query=query,
