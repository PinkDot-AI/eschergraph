...
def test_check_property_ext_pass():
...
def test_check_property_ext_fail():
...
def test_check_node_edge_ext_pass():
  valid_node_edge_ext = {
...
def test_check_node_edge_ext_fail():
